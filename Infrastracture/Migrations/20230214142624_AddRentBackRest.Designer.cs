...
namespace Infrastracture.Migrations
{
    ...
    [Migration("20230214142624_AddRentBackRest")]
    partial class AddRentBackRest
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Entities.CustomerRent", b =>
                {
                    ...
                    b.Property<double>("RentBackDiscount")
                        .HasColumnType("float");

                    b.Property<double>("RentBackRest")
                        .HasColumnType("float");

                    b.Property<double>("RentDiscount")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("Core.Entities.CustomerReservationPhoto", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("CustomerReservationId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("CustomerReservationPhoto");
                });

            modelBuilder.Entity("Core.Entities.CustomerViolation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("ViolationState")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("CustomerViolations");
                });

            modelBuilder.Entity("Core.Entities.CustomerViolationPhoto", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("CustomerViolationId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("CustomerViolationId");

                    b.ToTable("CustomerViolationPhotos");
                });
            ...
            modelBuilder.Entity("Core.Entities.CustomerReservationPhoto", b =>
                {
                    b.HasOne("Core.Entities.CustomerReservation", "CustomerReservation")
                        .WithMany("CustomerReservationPhotos")
            ...
            modelBuilder.Entity("Core.Entities.CustomerViolationPhoto", b =>
                {
                    b.HasOne("Core.Entities.CustomerViolation", "CustomerViolation")
                        .WithMany("CustomerViolationPhotos")
                        .HasForeignKey("CustomerViolationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("CustomerViolation");
                });
            ...
            modelBuilder.Entity("Core.Entities.CustomerReservation", b =>
                {
                    b.Navigation("CustomerReservationPhotos");
                });

            modelBuilder.Entity("Core.Entities.CustomerViolation", b =>
                {
                    b.Navigation("CustomerViolationPhotos");
                });
